...
const NAV_CONFIG = {
  employee: [
    ...
    { to: '/employee/announcements', icon: MessageSquare, label: 'Announcement', isLucide: true },
  ...
  hr: [
    ...
    { to: '/hr/communication', icon: MessageSquare, label: 'Announcement', isLucide: true },
    { to: '/support/issues', icon: LifeBuoy, label: 'Issue Support', isLucide: true },
    { to: '/support/bugs', icon: Bug, label: 'Bug Sheet', isLucide: true },
  ...
  pmo: [
    ...
    { to: '/pmo/communication', icon: MessageSquare, label: 'Announcement', isLucide: true },
  ...
  admin: [
    ...
    { to: '/admin/announcements', icon: MessageSquare, label: 'Announcement', isLucide: true },
